...
namespace WinUI3_WebView2_Sample.Views
{
    ...
    /// </summary>
    public sealed partial class WebViewUserControl : UserControl
    {
        public static readonly DependencyProperty PreviewContentProperty =
            DependencyProperty.Register(nameof(PreviewContent), typeof(string), typeof(WebViewUserControl), new PropertyMetadata(null, OnPreviewContentChanged));
        ...
        {
            var uc = d as WebViewUserControl;
