...
namespace WinUI3_WebView2_Sample.Views
{
    ...
    /// </summary>
    public sealed partial class WebViewUserControl2 : UserControl
    {
        public static readonly DependencyProperty PreviewContentProperty =
            DependencyProperty.Register(nameof(PreviewContent), typeof(string), typeof(WebViewUserControl2), new PropertyMetadata(null, OnPreviewContentChanged));
        ...
        {
            var uc = d as WebViewUserControl2;
            uc?.OnPreviewContentChanged((string)e.NewValue);
        }

        private void OnPreviewContentChanged(string webUrl)
        {
            WebView.CoreWebView2.Navigate(webUrl);
        }

        public WebViewUserControl2()
        {
